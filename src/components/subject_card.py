...
def subject_card(name, code, section, stats=None, footer_call_back=None):
    html = f"""
        ...
        <p style="color:#64748b; margin: 10px 0;">Code : <span style="background;#E0E3FF; color:#5865F2; padding:2px 8px; border-radius:5p">{code}  </span>| Section : {section}</p>
