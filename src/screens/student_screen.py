...
import time
from src.components.dialog_enroll import dialog_enroll
...
def student_dashboard():
    ...
    for i,sub_node in enumerate(subjects):
        ...
        def unenroll_button():
                if st.button("Unenroll from this course", type='tertiary', width='stretch', key=f"unenroll-{sub['subject_code']}"):
        ...
        with cols[i % 2]:
            subject_card (
                ...
                footer_call_back=unenroll_button
            )
...
def student_screen():
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name = st.text_input("Enter your name", placeholder='E.g. Raj Patel')   

            st.subheader('Optional : Voice recognition')  
